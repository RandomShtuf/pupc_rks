        ...
        <div id="datatable_wrapper" class="float-end">
            <div class="dropdown card-header-dropdown">
                ...
                <a class="btn btn-sm btn-outline-primary waves-effect waves-light" data-bs-toggle="modal"
                    data-bs-target="#addSubject">Add
                </a>
            </div>
        </div>

        @include('admin_panel.subjects.add')
                ...
                <div class="card">
                    <div class="card-body btn btn-outline-light waves-effect">
                        <div class="d-flex justify-content-between align-items-center">
                            <a href="{{ route('record.index', ['processId' => $process->id, 'sectionId' => $section->id, 'subjectId' => $subject->id]) }}" class="d-flex align-items-center">
                            ...
                            {{-- <div class="offcanvas offcanvas-end" tabindex="-1"
                                id="offcanvasRight_{{ $barangay->id }}"
